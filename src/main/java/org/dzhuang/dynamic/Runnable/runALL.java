...
public class runALL {
	...
	static String DyNet;
	static String intNet;
	static Clustering clustering = null;
	static Network oldNetwork;
	static double resolution2;
	static double maxModularity;
	static Random random;
	static HashMap<String, Double> alpha2;
	static double[] beta;
	static VOSClusteringTechnique VOSClusteringTechnique_temporary;
	...
	//	for(int i=1;i<=1;i++) {	//1000 idi ben 2 yaptım		
		...
		/*	runLouvain("5x5_v1", 2, i);
			runDynamicModularity("5x5_v1", 2, i); */
	
	//		runLouvain("20x20_v2", 20, i);
		//	runDynamicModularity("20x20_v2", 20, i);
	//		runEXP("2x2_v1", i);
			
	/*		runLouvain("30x30_v2", 25, i);
			runDynamicModularity("30x30_v2", 25, i);
	*/
	/*		runLouvain("10subat_30x30", 10, i);
			runDynamicModularity("10subat_30x30", 10, i);
	*/
			
	/*		
			runLouvain("16x16_v1", 15, i);
			runDynamicModularity("16x16_v1", 15, i);
	*/	
		/*	
			runDynamicModularity1("16x16_v1", 1, i);
			DynaMo("16x16_v1", 2, i);
			DynaMo("16x16_v1", 3, i);
			DynaMo("16x16_v1", 4, i);
			DynaMo("16x16_v1", 5, i);
			...
			DynaMo("16x16_v1", 8, i);
			DynaMo("16x16_v1", 9, i);
			DynaMo("16x16_v1", 10, i);
			DynaMo("16x16_v1", 11, i);
			DynaMo("16x16_v1", 12, i);
			DynaMo("16x16_v1", 13, i);
			DynaMo("16x16_v1", 14, i);
			DynaMo("16x16_v1", 15, i);*/
			
	//		runLouvain("8x8_v1", 7, i);
	//		runDynamicModularity("8x8_v1", 7, i);
